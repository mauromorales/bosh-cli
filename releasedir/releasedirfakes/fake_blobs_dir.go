...
type FakeBlobsDir struct {
	...
	ContainsSymlinksStub        func() bool
	containsSymlinksMutex       sync.RWMutex
	containsSymlinksArgsForCall []struct{}
	containsSymlinksReturns     struct {
		result1 bool
	}
	containsSymlinksReturnsOnCall map[int]struct {
		result1 bool
	}
...
func (fake *FakeBlobsDir) ContainsSymlinks() bool {
	fake.containsSymlinksMutex.Lock()
	ret, specificReturn := fake.containsSymlinksReturnsOnCall[len(fake.containsSymlinksArgsForCall)]
	fake.containsSymlinksArgsForCall = append(fake.containsSymlinksArgsForCall, struct{}{})
	fake.recordInvocation("ContainsSymlinks", []interface{}{})
	fake.containsSymlinksMutex.Unlock()
	if fake.ContainsSymlinksStub != nil {
		return fake.ContainsSymlinksStub()
	}
	if specificReturn {
		return ret.result1
	}
	return fake.containsSymlinksReturns.result1
}

func (fake *FakeBlobsDir) ContainsSymlinksCallCount() int {
	fake.containsSymlinksMutex.RLock()
	defer fake.containsSymlinksMutex.RUnlock()
	return len(fake.containsSymlinksArgsForCall)
}

func (fake *FakeBlobsDir) ContainsSymlinksReturns(result1 bool) {
	fake.ContainsSymlinksStub = nil
	fake.containsSymlinksReturns = struct {
		result1 bool
	}{result1}
}

func (fake *FakeBlobsDir) ContainsSymlinksReturnsOnCall(i int, result1 bool) {
	fake.ContainsSymlinksStub = nil
	if fake.containsSymlinksReturnsOnCall == nil {
		fake.containsSymlinksReturnsOnCall = make(map[int]struct {
			result1 bool
		})
	}
	fake.containsSymlinksReturnsOnCall[i] = struct {
		result1 bool
	}{result1}
}
